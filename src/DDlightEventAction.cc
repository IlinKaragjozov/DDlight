...
// note DMXPmtHit.hh and DMXScintHit.hh are included in DDlightEventAction.hh
...
DDlightEventAction::DDlightEventAction()
    : runAct(0), genAction(0), hitsfile(0), pmtfile(0)
{

  // create messenger
  eventMessenger = new DDlightEventActionMessenger(this);
...
void DDlightEventAction::BeginOfEventAction(const G4Event *evt)
{
  ...
  if (!runAct)
    runAct =
        dynamic_cast<const DDlightRunAction *>(G4RunManager::GetRunManager()->GetUserRunAction());

  if (!genAction)
    genAction = dynamic_cast<const DDlightPrimaryGeneratorAction *>(G4RunManager::GetRunManager()->GetUserPrimaryGeneratorAction());
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void DDlightEventAction::writeScintHitsToFile()
{
  ...
  if (S_hits)
  {
    ...
    else if (firstParticleName == "neutron")
      firstparticleIndex = 2;
    else if (firstParticleName == "electron")
      firstparticleIndex = 3;
    else if (firstParticleName == "positron")
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void DDlightEventAction::writePmtHitsToFile(const DMXPmtHitsCollection *hits)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void DDlightEventAction::drawTracks(const G4Event *evt)
{
