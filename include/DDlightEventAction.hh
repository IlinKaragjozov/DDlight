...
#ifndef DDlightEventAction_h
#define DDlightEventAction_h 1
...
class DDlightRunAction;
class DDlightPrimaryGeneratorAction;
class DDlightEventActionMessenger;
//class DMXAnalysisManager;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
class DDlightEventAction : public G4UserEventAction {

  public:
    DDlightEventAction();
    virtual ~DDlightEventAction();
  ...
  private:
    ...
    G4int saveHitsFlag;         
    G4int printModulo;                         
    DDlightEventActionMessenger*  eventMessenger;

    const DDlightRunAction*    runAct;  //pointer to run action
    const DDlightPrimaryGeneratorAction* genAction; // pointer to particle generator
